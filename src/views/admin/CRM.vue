<template>
  <v-container fluid class="pa-md-6 pa-4 crm-dashboard">
    <v-toolbar color="transparent" class="px-0 mb-6">
      ...
      <v-btn variant="tonal" @click="showComparativeModal = true" class="mr-2">
    ...
    <CrmComparativeReportModal
      :show="showComparativeModal"
      @close="showComparativeModal = false"
    />
    </v-container>
</template>
...
// --- IMPORT NOVO ---
const CrmComparativeReportModal = defineAsyncComponent(() => import('@/components/admin/crm/CrmComparativeReportModal.vue'));
...
// --- NOVO REF ---
const showComparativeModal = ref(false);
