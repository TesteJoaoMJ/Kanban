      ...
      <v-row class="fill-height ma-0" align="center">
        ...
        <v-col cols="12" md="7" lg="8" class="d-none d-md-flex flex-column justify-end pa-12 pb-16 fill-height">
          <div class="mb-4">
            <h1 class="text-h2 font-weight-black text-white mb-2 leading-tight tracking-tighter">
              MJProcess<span class="text-indigo-lighten-2">.</span>
            </h1>
            ...
            <div class="d-flex align-center gap-4 mt-6 text-caption text-white opacity-60 font-mono">
              <span class="d-flex align-center gap-1"><v-icon size="14">mdi-shield-lock-outline</v-icon> IAM Security</span>
              <span>|</span>
              <span class="d-flex align-center gap-1"><v-icon size="14">mdi-server-network</v-icon> Access Protocol</span>
            </div>
          </div>
        </v-col>
        ...
        <v-col cols="12" md="5" lg="4" class="d-flex align-center justify-center pa-6">
          ...
          <v-card class="white-glass-card rounded-xl pa-9 text-center d-flex flex-column align-center w-100" max-width="460" elevation="24">
            ...
            <v-avatar color="indigo-lighten-5" size="80" class="mb-5 border-light">
              <v-icon size="46" color="indigo-darken-3" class="sad-face-icon">mdi-emoticon-sad-outline</v-icon>
            </v-avatar>

            <div class="text-overline text-indigo-darken-3 font-weight-black mb-1 tracking-widest">Segurança Corporativa</div>
            <h2 class="text-h5 font-weight-black text-grey-darken-4 mb-5 tracking-tight">Acesso Restrito</h2>
            ...
            <p class="text-body-2 text-grey-darken-2 mb-7 px-2" style="line-height: 1.6;">
              Parece que você esbarrou em uma área protegida. O seu atual <strong>nível de credencial</strong> não possui as permissões necessárias para visualizar este conteúdo.
            </p>
            ...
            <div class="info-box pa-4 mb-7 text-left d-flex gap-3 align-start w-100 rounded-lg border-thin">
              ...
              <span class="text-[11px] text-grey-darken-3 font-weight-medium" style="line-height: 1.4;">
                Caso acredite ser um erro do sistema ou necessite acessar este módulo para suas funções, solicite a liberação imediata ao Administrador.
              </span>
            </div>
            ...
            <div class="d-flex flex-column gap-3 w-100">
                ...
                <v-btn
                  ...
                  size="large"
                  block
                  class="font-weight-bold text-caption rounded-lg border-thin"
                  height="48"
                  @click="goBack"
                >
            ...
            <div class="mt-7 text-[10px] text-grey-darken-1 font-mono d-flex flex-column align-center gap-1 opacity-80">
               <span>Interceptação Auditada via IAM</span>
               <span>{{ currentIp }}</span>
            </div>
...
const currentIp = ref('Verificando conexão...');

// Imagens do Carrossel de Fundo
const images = [
  'https://images.unsplash.com/photo-1472214103451-9374bd1c798e?q=80&w=2070',
  'https://images.unsplash.com/photo-1448375240586-882707db8855?q=80&w=2070',
  ...
  'https://images.unsplash.com/photo-1433086966358-54859d0ed716?q=80&w=2070',
  ...
  'https://images.unsplash.com/photo-1505820013142-f86a3439c5b2?q=80&w=2071',
  'https://images.unsplash.com/photo-1473580044384-7ba9967e16a0?q=80&w=2070',
  'https://images.unsplash.com/photo-1531366936337-77cf5e615ed9?q=80&w=2070'
];
...
const fetchIp = async () => {
  try {
    ...
    currentIp.value = `IP Origem: ${data.ip}`;
  } catch (e) {
    currentIp.value = 'IP: Rastreamento Indisponível';
  }
};
...
.bg-image {
  ...
  /* Aplica a animação de zoom lento de 15 segundos */
...
/* Efeito sutil no ícone */
.sad-face-icon {
  animation: floatSlightly 4s ease-in-out infinite;
}
